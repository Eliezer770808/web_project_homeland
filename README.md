...
**Header**: Conteniendo únicamente el logotipo de la galería de arte
...
**Places:** muestra los nombres de diversas ciudades, foto representativa que se oscurece al pasar el mouse encima de ella, el nombre del artista así como una breve descripción de la misma (la mejor es la última).
